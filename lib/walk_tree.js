...
(function() {
  var abspath, copyFile, copyTreeSync, fs, path, walkSync, walkTreeSync;
  ...
  walkTreeSync = function(dir, f_match, f_visit) {
    var _walk_tree;
  ...
  copyTreeSync = function(dir_from, dir_to, f_match) {
  ...
  module.exports = {
    copyTreeSync: copyTreeSync,
    walkTreeSync: walkTreeSync,
    walkSync: walkSync
  };
